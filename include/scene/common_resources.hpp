...
Texture *morning = add(new Texture("texture/skylight-morn.exr"));
Texture *morning_half = add(new Texture("texture/skylight-morn-half.png"));
Texture *dusk = add(new Texture("texture/skylight-dusk.exr"));
Texture *dusk2 = add(new Texture("texture/500-free-hdri-skies-com.exr"));
Texture *sunset = add(new Texture("texture/385-free-hdri-skies-com.exr"));
Texture *milky_way = add(new Texture("texture/milky-way.png"));
...
Material *translucent = add(new Material({{new DiffuseBSDF(), 0.3}, {new TranslucentBSDF(), 0.7}}, white));